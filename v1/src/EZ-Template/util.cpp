...
/*
std::list<int> L_MOTOR_PORTS;
std::list<int> R_MOTOR_PORTS;

pros::Motor ll_motor(abs(L_MOTOR_PORTS.front()), MOTOR_GEARSET_6, is_reversed(L_MOTOR_PORTS.front()), MOTOR_ENCODER_COUNTS);
pros::Motor rr_motor(abs(R_MOTOR_PORTS.front()), MOTOR_GEARSET_6, is_reversed(R_MOTOR_PORTS.front()), MOTOR_ENCODER_COUNTS);
*/
